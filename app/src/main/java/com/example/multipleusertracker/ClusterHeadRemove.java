...
public class ClusterHeadRemove {
    public String roll;
  ...
  public  ClusterHeadRemove(){}

    public ClusterHeadRemove(String roll, double stdlatitude, double stdlongitude, double endlatitude, double endlongitude, float distance) {
        this.roll = roll;
