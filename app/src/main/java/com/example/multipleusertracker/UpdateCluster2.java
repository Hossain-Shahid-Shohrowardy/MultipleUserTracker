...
public class UpdateCluster2 {
    ...
    public   UpdateCluster2(){

    }

    public UpdateCluster2(String roll, double stdlatitude, double stdlongitude, double endlatitude, double endlongitude, float distance) {
        this.roll = roll;
